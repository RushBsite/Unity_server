...
class C_Chat : IPacket
{
    ...
    public  ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count),(ushort)PacketID.C_Chat);// slice 하더라도 s 변화 x
        count += sizeof(ushort);
...
class S_Chat : IPacket
{
    ...
    public  ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count),(ushort)PacketID.S_Chat);// slice 하더라도 s 변화 x
        count += sizeof(ushort);
